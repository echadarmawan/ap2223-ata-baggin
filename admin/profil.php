...
<head>
	...
	<title>Profil - Admin | Baggin</title>
		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST">
					<input type="text" name="nama" placeholder="Anggota Admin" class="input-control" value="<?php echo $d->admin_name ?>" required>
					<input type="text" name="user" placeholder="Username" class="input-control" value="<?php echo $d->username ?>" required>
					<input type="text" name="hp" placeholder="Nomor Telepon" class="input-control" value="<?php echo $d->admin_telp ?>" required>
